...
export class ProjectService
{
     ...
     */
    public static async createProject(name: string, workspaceId: string) : Promise<Project>
    {
     ...
     */
    public static async updateProject(id: string, title: string | null, description : string | null, status: string | null, priority: string | null, startDate: Date | null, endDate: Date | null) : Promise<Project>
    {
        // * Create a new organization
        const project = new UpdateProjectRequest(id, title, description, status, priority, startDate, endDate);
     ...
     */
    public static async addResourceToProject(projectId: string, resourceId: string) : Promise<Resource>
    {
        // # Send the request to the API
        const response = await fetch(`https://localhost:7006/api/projects/${projectId}/resources/${resourceId}`, {
            method: 'POST'
        });
     ...
     */
    public static async getResourcesForProject(projectId: string) : Promise<Resource[]>
    {
        // # Send the request to the API
        const response = await fetch(`https://localhost:7006/api/projects/${projectId}/resources`, {
            method: 'GET'
        });
     ...
     * @param resourceId The ID of the resource
     */
    public static async getResourceForProjectById(projectId: string, resourceId: string) : Promise<Resource>
    {
        // # Send the request to the API
        const response = await fetch(`https://localhost:7006/api/projects/${projectId}/resources/${resourceId}`, {
            method: 'GET'
     ...
     */
    public static async updateResourceForProject(projectId: string, resourceId: string, title: string | null, url: string | null, description: string | null, type: string | null) : Promise<Resource>
    {
        // * Create a new organization
     ...
     * @param resourceId The ID of the resource
     */
    public static async deleteResourceForProject(projectId: string, resourceId: string) : Promise<void>
    {
        // # Send the request to the API
        const response = await fetch(`https://localhost:7006/api/projects/${projectId}/resources/${resourceId}`, {
            method: 'DELETE'
     ...
     */
    public static async createIterationForProject(projectId: string, title: string) : Promise<ProjectActivity>
    {
        // * Create the request body
        const iteration = new CreateIterationRequest(title);

        // # Send the request to the API
        const response = await fetch(`https://localhost:7006/api/projects/${projectId}/iterations`, {
            method: 'POST',
        ...
        if (response.ok) {
            ...
            // * Convert the response to an organization object
            return new ProjectActivity(data.id, data.containedIn, data.title, data.description, data.items);
        } else {
            // ! Throw an error
     ...
     */
    public static async getIterationsForProject(projectId: string) : Promise<ProjectActivity[]>
    {
        // # Send the request to the API
        const response = await fetch(`https://localhost:7006/api/projects/${projectId}/iterations`, {
            method: 'GET'
        ...
        if (response.ok) {
            ...
            // * Convert the response to an organization object
            return data.map((iteration: ProjectActivity) => new ProjectActivity(iteration.id, iteration.containedIn, iteration.title, iteration.description, iteration.items));
        } else {
            // ! Throw an error
     ...
     */
    public static async getIterationForProjectById(projectId: string, iterationId: string) : Promise<ProjectActivity>
    {
        // # Send the request to the API
        const response = await fetch(`https://localhost:7006/api/projects/${projectId}/iterations/${iterationId}`, {
            method: 'GET'
        });
     ...
     */
    public static async updateIterationForProject(projectId: string, iterationId: string, title: string | null, description: string | null, itemsToAdd : string[] | null, itemsToRemove : string[] | null) : Promise<ProjectActivity>
    {
        // * Create the request body
        const iteration = new UpdateIterationRequest(title, description, itemsToAdd, itemsToRemove);
     ...
     * @param iterationId The ID of the iteration
     */
    public static async deleteIterationForProject(projectId: string, iterationId: string) : Promise<void>
    {
        // # Send the request to the API
        const response = await fetch(`https://localhost:7006/api/projects/${projectId}/iterations/${iterationId}`, {
            method: 'DELETE'
     ...
     */
    public static async createMilestoneForProject(projectId: string, title: string) : Promise<ProjectActivity>
    {
        // * Create the request body
        const iteration = new CreateMilestoneRequest(title);

        // # Send the request to the API
        const response = await fetch(`https://localhost:7006/api/projects/${projectId}/milestones`, {
            method: 'POST',
            body: JSON.stringify(iteration),
            headers: {
                'Content-Type': 'application/json'
     ...
     */
    public static async getMilestonesForProject(projectId: string) : Promise<ProjectActivity[]>
    {
        // # Send the request to the API
        const response = await fetch(`https://localhost:7006/api/projects/${projectId}/milestones`, {
            method: 'GET'
        ...
        if (response.ok) {
            ...
            // * Convert the response to an organization object
            return data.map((milestone: ProjectActivity) => new ProjectActivity(milestone.id, milestone.containedIn, milestone.title, milestone.description, milestone.items));
        } else {
            // ! Throw an error
     ...
     */
    public static async getMilestoneForProjectById(projectId: string, milestoneId: string) : Promise<ProjectActivity>
    {
        // # Send the request to the API
        const response = await fetch(`https://localhost:7006/api/projects/${projectId}/milestones/${milestoneId}`, {
            method: 'GET'
        });
     ...
     */
    public static async updateMilestoneForProject(projectId: string, milestoneId: string, title: string | null, description: string | null, itemsToAdd : string[] | null, itemsToRemove : string[] | null) : Promise<ProjectActivity>
    {
        // * Create the request body
        const milestone = new UpdateMilestoneRequest(title, description, itemsToAdd, itemsToRemove);
     ...
     * @param milestoneId The ID of the milestone
     */
    public static async deleteMilestoneForProject(projectId: string, milestoneId: string) : Promise<void>
    {
        // # Send the request to the API
        const response = await fetch(`https://localhost:7006/api/projects/${projectId}/milestones/${milestoneId}`, {
            method: 'DELETE'
