...
export default class OrganizationService {
   ...
   * @returns All organizations for the user
   */
  ...
  public static async updateOrganization(
    ...
    // * Create a new organization
    const organization = new UpdateOrganizationRequest(
      name,
      membersToAdd,
      membersToRemove
    );
   ...
   */
  public static async createOrganizationResource(
   ...
   */
  public static async getOrganizationResources(
    organizationId: string
  ): Promise<Resource[]> {
    // # Send the request to the API
    const response = await fetch(
   ...
   */
  public static async getOrganizationResource(
    organizationId: string,
    resourceId: string
  ): Promise<Resource> {
    // # Send the request to the API
   ...
   */
  public static async updateOrganizationResource(
    organizationId: string,
    resourceId: string,
    title: string | null,
    url: string | null,
   ...
   * @param resourceId The ID of the resource
   */
  public static async deleteOrganizationResource(
    organizationId: string,
    resourceId: string
  ): Promise<void> {
    // # Send the request to the API
